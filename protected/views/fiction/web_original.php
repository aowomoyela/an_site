...
<p>
	As one of Merigoa's most respected, most feared, and most empowered law enforcement agencies, Demonology, Perfidy and Security is tasked with mitigating the 
	demonic threat and prosecuting those who collude with demons. But the job takes agents of the DPS into close contact with demons, themselves, and to the ragged 
	edges of law, propriety, and personal conviction.
</p>

<h2 class="right_header"><a href="<?php echo Yii::app()->createUrl('fiction/pixel') ?>">Pixel-Stained (coming soon)</a></h2>
