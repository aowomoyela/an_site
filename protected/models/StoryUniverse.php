...
/**
 * This is the model class for table "story_universe".
 *
 * The followings are the available columns in table 'story_universe':
 * @property integer $story_universe_id
 * @property integer $story_id
 * @property integer $universe_id
 */
class StoryUniverse extends CActiveRecord
{
	/**
